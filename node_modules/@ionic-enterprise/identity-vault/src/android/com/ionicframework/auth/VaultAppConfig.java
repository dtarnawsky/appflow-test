...
public class VaultAppConfig {
    ...
    public static void configure(JSONObject config, Activity activity) {
        ...
        instance.pinPromptSubtitle = config.optString("androidPINPromptSubtitle", instance.pinPromptSubtitle);
        instance.pinPromptVerifyTitle = config.optString("androidPINPromptVerifyTitle", instance.pinPromptVerifyTitle);
        instance.pinPromptTitle = config.optString("androidPINPromptTitle", instance.pinPromptTitle);
        instance.pinPromptConfirmTitle = config.optString("androidPINPromptConfirmTitle", instance.pinPromptConfirmTitle);
        instance.pinPromptConfirmButtonText = config.optString("androidPINPromptConfirmButtonText", instance.pinPromptConfirmButtonText);
        instance.pinPromptNegativeButtonText = config.optString("androidPINPromptNegativeButtonText", instance.pinPromptNegativeButtonText);
