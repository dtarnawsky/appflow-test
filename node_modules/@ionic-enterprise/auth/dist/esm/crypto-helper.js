...
export const generateChallengeAndVerifier = async (useBase64String = false) => {
...
export const base64Encode = (byteArray) => {
...
export const escapeUrl = (baseString) => {
...
export const unescapeUrl = (baseString) => {
