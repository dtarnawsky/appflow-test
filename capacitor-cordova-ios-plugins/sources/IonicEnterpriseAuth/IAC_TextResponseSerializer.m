...
@implementation IAC_TextResponseSerializer

+ (instancetype)serializer {
  IAC_TextResponseSerializer *serializer = [[self alloc] init];
  return serializer;
}
  ...
  if (response && [response isKindOfClass:[NSHTTPURLResponse class]]) {
    ...
    if (data && !*decoded) {
      NSMutableDictionary *mutableUserInfo = [@{
        ...
        IAC_AFNetworkingOperationFailingURLResponseDataErrorKey: data,
        IAC_AFNetworkingOperationFailingURLResponseBodyErrorKey: @"Could not decode response data due to invalid or unknown charset encoding",
      } mutableCopy];
      ...
      if (data) {
        ...
        mutableUserInfo[IAC_AFNetworkingOperationFailingURLResponseBodyErrorKey] = *decoded;
      }
